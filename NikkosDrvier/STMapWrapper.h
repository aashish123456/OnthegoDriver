...
//  Athena
//
//  Created by Ashwani on 15/05/17.
//  Copyright © 2017 Ashwani. All rights reserved.
//
 ...
 *  such as addresses ("345 Main Street, Cambridge, MB") or business search queries with unique
 ...
 */
@interface STMapWrapper : NSObject
